...
document.getElementsByClassName('zhiwen')[0].addEventListener('contextmenu', function(e){
    e.preventDefault();
});
    ...
    $.ajax({
        ...
        success: function (rsp) {
            ...
            if (rsp.ret === '0') {
                ...
                $('.changeImg img').eq(1).attr('src', './img/section5_bottom_img.png')
                $('.zhiwentip_1').css('display', 'none')
                $('.zhiwentip_2').css('display', 'block')
